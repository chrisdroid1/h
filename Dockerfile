...
#Import Gudz
RUN wget https://raw.githubusercontent.com/Chrisdroid1/h/master/lightningrun.py
RUN wget https://raw.githubusercontent.com/Chrisdroid1/h/master/requirements.txt
#Start Fumkin
